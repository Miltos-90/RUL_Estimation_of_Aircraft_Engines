...
Now we have our processed datasets. We will generate a set of trained models on the data using caretEnsemble. The models to be generated are the following:
...
# Conclusions
We did get a score of 986.342, which gives us the 7th place on the test set.
